...
class Cliente extends Model
{
    ...
    public static function all($columns = ['*'])
    {
        ...
        $rows = static::firestoreClient()->listDocuments('clientes');
    ...
    public static function find($id, $columns = ['*'])
    {
        ...
        $doc = static::firestoreClient()->getDocument('clientes', (string)$id);
        if (!$doc) return null;
        $m = new static();
        $m->exists = true;
    ...
    public static function create(array $attributes = [])
    {
        ...
        $id = uniqid();
        static::firestoreClient()->setDocument('clientes', $id, $attributes);
        $m = new static();
        $m->exists = true;
    ...
    public function save(array $options = [])
    {
        ...
        unset($data['id']);
        static::firestoreClient()->setDocument('clientes', $id, $data);
    ...
    public function delete()
    {
        ...
        if (!$id) return false;
        static::firestoreClient()->deleteDocument('clientes', (string)$id);
        $this->exists = false;
        return true;
    }
